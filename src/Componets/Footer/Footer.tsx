      ...
      <div className="max-w-7xl mx-auto px-6 py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 items-center">
          ...
          <div className="flex flex-wrap justify-center gap-6 text-gray-400 text-sm md:text-base">
            ...
            <a href="#testimonial" className="hover:text-pink-400 transition-colors">Testimonials</a>
          ...
          <div className="flex justify-center md:justify-end">
            ...
            >
              <input
                ...
                className="flex-1 px-4 py-2 bg-transparent text-sm text-gray-300 focus:outline-none"
              />
              <button
                type="submit"
        ...
        <div className="flex flex-col md:flex-row justify-between items-center text-center md:text-left gap-6">
          ...
          <div className="flex flex-col sm:flex-row gap-4 sm:gap-8 text-gray-400 text-sm">
            <a href="mailto:sakib@example.com" className="hover:text-pink-400 transition-colors">
        ...
        <p className="mt-6 text-center text-gray-500 text-xs md:text-sm">
          ...
          <span className="text-pink-400">Sazzadur Rahman Sakib</span>
        </p>
      </div>
    </footer>
  );
